#!/usr/bin/env python3
"""Poll the voice-clone candidate-test Kaggle kernel and pull output."""
from __future__ import annotations
import subprocess, sys, time
from pathlib import Path

SLUG = "forts845/openmontage-voice-clone-candidate-test"
OUT = Path("/workspaces/OpenMontage/tools/kaggle/voice_clone_test/result")
